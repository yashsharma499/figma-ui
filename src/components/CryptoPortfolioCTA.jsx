          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-6 sm:gap-10 items-center relative z-10">
            ...
            <div className="space-y-3 sm:space-y-6 text-center lg:text-left mt-6 sm:mt-0">
              ...
              <div className="hidden sm:flex gap-4 pt-2 justify-center lg:justify-start">
                <img
                  ...
                  className="h-[48px] hover:opacity-90 cursor-pointer"
                />
                <img
            ...
            <div
              className="relative flex justify-center lg:justify-end 
                h-[260px] sm:h-[420px] md:h-[520px] lg:h-[560px]"
            >
              {" "}
              {/* Increased height */}
              <img
                src="/Gemini3.png"
                className="absolute top-[10px] sm:top-[20px] left-[5%] sm:left-[5%]
               w-[260px] sm:w-[360px] md:w-[420px] lg:w-[480px]    /* 🔥 Increased width */
               z-20 drop-shadow-[0_0_35px_rgba(0,0,0,0.7)]"
              />
            </div>
          </div>
