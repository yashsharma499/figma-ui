    ...
    <section className="w-full bg-[#0b0b0e] flex justify-center pt-16 lg:pt-[120px] pb-0">
      <div className="relative w-full max-w-[1728px] overflow-hidden">
        ...
        <div className="flex flex-col lg:hidden overflow-hidden">
          ...
          <div className="w-full flex">
            <h1 className="text-white font-extrabold text-[44px] leading-none flex items-center">
              <span className="text-yellow-400 text-[46px] mr-0">⚡</span>
              Faster
            </h1>
          </div>

          <div className="w-full flex justify-start mt-2 ml-15">
        ...
        <div className="hidden lg:block relative">
          ...
          <div className="absolute top-24 left-28 z-[1]"> 
          ...
          {/* PHONE — stays above text */}
          <div className="flex justify-center z-20 relative -translate-x-12"> 
            <img
              src="/phone.png"
              alt="Phone UI"
              className="w-[360px]"
