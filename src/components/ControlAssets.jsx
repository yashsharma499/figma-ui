...
export default function ControlAssets() {
  return (
    <section className="w-full bg-deep-dark text-white py-[120px] flex justify-center">
      <div className="w-full max-w-[1728px] px-6 md:px-12 lg:px-20">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-y-20 lg:gap-y-24 gap-x-16">
          ...
          {/* ICON */}
          <div className="flex justify-start lg:justify-end items-start order-1 lg:order-2">
            <img
              src="/shield.png"
              alt="Security Shield"
              className="w-[64px] lg:w-[280px]"
            />
          </div>
          ...
          {/* ICON */}
          <div className="flex justify-start lg:justify-start items-start order-3">
            <img
              src="/social-lock.png"
              alt="Social login lock"
              className="w-[64px] lg:w-[300px]"
            />
          </div>
          ...
          <div className="max-w-md order-6 lg:order-5">
            ...
            <div className="mt-8">
              <img
                ...
                alt="Get the App"
                className="h-[56px] cursor-pointer hover:opacity-90 transition"
              />
            </div>
          </div>

          {/* ICON */}
          <div className="flex justify-start lg:justify-end items-start order-5 lg:order-6">
            <img
              src="/tokens.png"
              alt="Crypto tokens"
              className="w-[64px] lg:w-[300px]"
